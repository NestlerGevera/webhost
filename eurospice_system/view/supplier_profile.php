    ...
    <div class="body-container">
        <div class="section-container" id="">
            <div class="container-me" id="store-header">
                <h1>Name of Supplier(Brand Name)</h1>
                <img src="../assets/images/hela-logo.svg" style="width: 150px; height: 150px; border-radius: 50%;" alt="">
                ...
                <div class="sales-btn">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><button class="dropdown-item" type="button">Daily Sales</button></li>
                            <li><button class="dropdown-item" type="button">Weekly Sales</button></li>
                            <li><button class="dropdown-item" type="button">Monthly Sales</button></li>
                            <li><button class="dropdown-item" type="button">Annual Sales</button></li>
                        </ul>
                    </div>
                </div>
            ...
            <img src="../assets/images/line-graph-placeholder.png" style="width: 600px;" alt="">
        </div>
    </div>
